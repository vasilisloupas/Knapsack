...
<p>Τα αρχεία αυτά βρίσκονται στους φακέλους Problems With n=10 (τα στιγμιότυπα με ν=10), Problems With n=50 (τα στιγμιότυπα με ν=50),  Problems With n=100 (τα στιγμιότυπα με ν=100) και Problems With n=500 (τα στιγμιότυπα με ν=500).</p>
